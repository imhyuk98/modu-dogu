...
const lifeCalcs: Item[] = [
  ...
  { title: "AI 식단 추천", href: "/calculators/macro-diet", emoji: "🥗", desc: "목표 칼로리와 영양 비율에 맞는 식단을 추천해요" },
  { title: "AI 운동 추천", href: "/calculators/exercise", emoji: "💪", desc: "목표와 운동 환경에 맞는 루틴을 추천해요" },
...
const funCalcs: Item[] = [
  ...
  { title: "AI 사주 분석", href: "/calculators/saju", emoji: "☯️", desc: "내 사주, 한 번 까보자" },
  { title: "AI 전생 테스트", href: "/calculators/past-life", emoji: "🔮", desc: "전생의 나 뭐였을까?" },
  { title: "AI 오늘의 운세", href: "/calculators/daily-fortune", emoji: "🌟", desc: "오늘 운빨 몇 점?" },
  { title: "커플 D-day", href: "/calculators/couple-dday", emoji: "💑", desc: "다음 기념일 놓치지 않기" },
  { title: "AI 심리 분석", href: "/tools/psychology-test", emoji: "🧠", desc: "내 선택엔 다 이유가 있음" },
  ...
  { title: "AI 꿈 해몽", href: "/tools/dream-interpretation", emoji: "🌙", desc: "그 꿈, 그냥 꿈은 아닐지도" },
  { title: "AI 타로", href: "/tools/tarot", emoji: "🃏", desc: "지금 나한테 필요한 카드" },
];
...
const games: Item[] = [
  ...
  { title: "오목", href: "/tools/omok", emoji: "⚫", desc: "AI 상대로 다섯 줄 도전" },
...
const tools: Item[] = [
  ...
  { title: "AI 닉네임 생성기", href: "/tools/nickname-generator", emoji: "🎭", desc: "원하는 분위기에 맞는 닉네임을 추천해요" },
  ...
  { title: "AI 작명기", href: "/tools/name-generator", emoji: "✍️", desc: "조건에 맞는 이름 후보를 추천해요" },
  { title: "AI 선물 추천", href: "/tools/gift-recommendation", emoji: "🎁", desc: "선물할 대상과 예산에 맞는 아이디어를 추천해요" },
  { title: "AI 인스타 해시태그", href: "/tools/hashtag-generator", emoji: "#️⃣", desc: "게시물 내용에 맞는 해시태그를 추천해요" },
  { title: "밈 카드 만들기", href: "/tools/meme-card", emoji: "🪪", desc: "문구를 넣어 영수증·상장·속보 카드를 만들어요", featured: true },
  { title: "AI 책 추천", href: "/tools/book-recommendation", emoji: "📚", desc: "기분과 관심사에 맞는 책을 추천해요" },
  { title: "AI 오늘 뭐 먹지", href: "/tools/food-recommendation", emoji: "🍽️", desc: "취향과 상황에 맞는 메뉴를 추천해요" },
  { title: "AI 영화 추천", href: "/tools/movie-recommendation", emoji: "🎬", desc: "장르와 기분에 맞는 영화를 추천해요" },
  { title: "AI 여행지 추천", href: "/tools/travel-recommendation", emoji: "✈️", desc: "취향과 조건에 맞는 여행지를 추천해요" },
  { title: "AI 패션 코디", href: "/tools/fashion-recommendation", emoji: "👗", desc: "상황과 취향에 맞는 코디를 추천해요" },
