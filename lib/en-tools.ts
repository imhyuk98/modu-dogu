...
export const englishTools: EnglishTool[] = [
  ...
  },
  {
    ...
    description: "Estimate monthly payments, total interest, and total repayment for a fixed-rate loan.",
    emoji: "🏦",
    keywords: ["loan calculator", "monthly payment", "loan interest calculator", "amortization"],
  },
  {
    slug: "gpa",
    group: "calculators",
    ...
    description: "Calculate a credit-weighted GPA on 4.0, 4.3, or 4.5 scales and exclude pass/fail courses.",
    emoji: "🎓",
    keywords: ["GPA calculator", "weighted GPA", "college GPA", "grade point average"],
  },
  {
    slug: "pyeong",
    group: "calculators",
    section: "calculators",
    title: "Square Meters, Pyeong & Square Feet Converter",
    shortTitle: "Area Converter",
    description: "Convert floor area between square meters, Korean pyeong, and square feet in either direction.",
    emoji: "📐",
    keywords: ["square meters to pyeong", "pyeong to square feet", "area converter"],
  },
  {
    slug: "running-pace",
    group: "calculators",
    ...
    description: "Turn a race distance and finish time into pace, speed, and common-distance projections.",
    emoji: "🏃",
    keywords: ["running pace calculator", "minutes per mile", "minutes per kilometer", "race pace"],
  },
  {
