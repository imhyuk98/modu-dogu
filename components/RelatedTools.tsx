...
const allItems: Record<string, { title: string; href: string; category: string }> = {
  ...
  tarot: { title: "타로 카드 뽑기", href: "/tools/tarot", category: "재미" },
  exercise: { title: "운동 루틴 추천", href: "/calculators/exercise", category: "생활" },
  "name-generator": { title: "이름 후보 추천", href: "/tools/name-generator", category: "도구" },
  "dream-interpretation": { title: "꿈 키워드 풀이", href: "/tools/dream-interpretation", category: "재미" },
  "gift-recommendation": { title: "선물 아이디어 추천", href: "/tools/gift-recommendation", category: "도구" },
  "hashtag-generator": { title: "인스타 해시태그 추천", href: "/tools/hashtag-generator", category: "도구" },
  "book-recommendation": { title: "책 추천 도우미", href: "/tools/book-recommendation", category: "도구" },
  "food-recommendation": { title: "오늘 뭐 먹지", href: "/tools/food-recommendation", category: "도구" },
  "movie-recommendation": { title: "영화 추천 도우미", href: "/tools/movie-recommendation", category: "도구" },
  "travel-recommendation": { title: "여행지 추천 도우미", href: "/tools/travel-recommendation", category: "도구" },
  "fashion-recommendation": { title: "패션 코디 추천", href: "/tools/fashion-recommendation", category: "도구" },
